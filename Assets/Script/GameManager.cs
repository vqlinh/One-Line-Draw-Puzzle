...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private Edge _edgePrefabs;
    [SerializeField] private Point _pointPrefabs;
    [SerializeField] private LineRenderer _hightLight;
    ...
    public void SpawnLevel()
    {
        ...
        for (int i = 0; i < _level.Points.Count; i++)
        {
            ...
            points[id] = Instantiate(_pointPrefabs);
        ...
        for (int i = 0; i < _level.Edges.Count; i++)
        {
            ...
            Edge spawnEdge= Instantiate(_edgePrefabs);
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            _hightLight.positionCount = 2;
            _hightLight.SetPosition(0, startPoint.Position);
            _hightLight.SetPosition(1, startPoint.Position);
        }
        else if (Input.GetMouseButton(0) && startPoint != null)
        {
            ...
            _hightLight.SetPosition(1, mousePos2D);
